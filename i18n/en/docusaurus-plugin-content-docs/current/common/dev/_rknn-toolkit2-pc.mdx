:::tip
This document demonstrates how to simulate YOLOv5 target segmentation model inference on an x86 PC using rknn-toolkit2. For environment setup, please refer to [RKNN Installation](./rknn_install).
:::
